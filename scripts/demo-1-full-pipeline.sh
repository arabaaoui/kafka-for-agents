...
echo "║    2. Simulator publishes orders → orders topic                            ║"
echo "║    3. Detection agent consumes orders → publishes anomalies               ║"
echo "║    4. Decision agent reads anomalies → writes tasks (via SKILL.md)         ║"
